...
unterscheiden. Für den Einsatz auf einem HPC-System kommt
zusätzlich die Frage hinzu, wie sich die Systeme dort
bereitstellen und mit dem Ressourcenverwalter betreiben lassen.
...
mit derselben Nutzlast umgesetzt werden. Die Systeme werden
...
bei der Ausführung dieser Workflows, gemessen an Makespan, Overhead und Koordinationsgrößen (F2)? Die
...
für den Vergleich der Systeme. Kapitel~\ref{sec:lokal} beschreibt
die Umsetzung der Workflow-Muster in den fünf Systemen und stellt
die Ergebnisse der lokalen Messungen dar.
