...
Überwachung des Ausführungszustands~\cite[S.~29]{badia2017workflows}\cite[S.~3]{suter2026terminology}.
...
Kontrollabhängigkeiten~\cite[S.~28]{badia2017workflows}. Bei
Datenabhängigkeiten ergibt sich die Verbindung zwischen den
Schritten aus dem Datenfluss, also aus den zwischen ihnen
weitergegebenen Daten, während Kontrollabhängigkeiten die
Ausführungsreihenfolge unabhängig von dieser Datenweitergabe
festlegen. In beiden Fällen wird ein Schritt erst ausführbar, wenn
die Schritte abgeschlossen sind, von denen er
abhängt~\cite[S.~8, ~10]{russell2006patterns}. Das
...
Batch-Scheduler~\cite[S.~5]{suter2026terminology}. In dieser Arbeit
wird hierfür Slurm eingesetzt.
...
eintreffen~\cite[S.~317]{ditommaso2017nextflow}.
...
Merlin ist ein Workflow-System aus dem HPC-Umfeld. Es wurde
...
Mittelpunkt. Jede vom System ausgeführte Berechnung und jeder
Workflow werden automatisch in einem Provenance-Graphen
aufgezeichnet, um die Reproduzierbarkeit der Ergebnisse zu
...
Für die Ausführung von Prozessen verwendet AiiDA mehrere Runner,
die von einem Daemon überwacht werden~\cite[S.~3]{huber2020aiida}. Die dabei
...
Workflows~\citeS.[~1]{diercks2023evaluation}.
...
sowohl lokal als auch auf einem HPC-System mit Slurm untersucht.