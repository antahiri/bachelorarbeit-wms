...
\begin{figure}[ht]
  ...
  \caption[Zeitstrahl eines Pipeline-Laufs mit der kurzen Rechenlast]{Zeitstrahl eines Pipeline-Laufs mit der kurzen Rechenlast. Der Balken von \texttt{PREPROCESS} wurde auf eine Mindestbreite von circa einer Sekunde gezogen. Der Schritt \texttt{PREPROCESS} dauerte laut Bericht 102\,ms, sein Balken erscheint dadurch rund zehnmal zu lang und ragt über den Beginn von \texttt{COMPUTE} hinaus. Die Ausführungszeiten überschneiden sich tatsächlich nicht.}
