...
unter denselben Bedingungen ausgeführt werden. Auf der zweiten Ebene wird untersucht, wie sich die
...
\begin{table}[H]
  ...
  \begin{tabular}{>{\raggedright\arraybackslash}p{1.8cm}
    ...
    AiiDA & vor \texttt{submit()} der WorkChain & terminaler Zustand des obersten WorkChain-Prozessknotens, Abfrage alle 50\,ms \\
