"""Gesamtlaufzeit des Pipeline-Musters je Rechenlast, MOGON im
exklusiven Betrieb. Gruppierte Balken je Rechenlast, Hoehe ist der
Median der Wiederholungen aus v2.

Aufruf aus dem Repo-Wurzelverzeichnis:
    python3 auswertung/plots_final/mogon/02_makespan_pipeline.py
"""
import sys
